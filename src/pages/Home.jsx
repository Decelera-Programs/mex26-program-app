...
export default function Home() {
  ...
  return (
      <div className="w-full pt-[30px] pb-6 sm:pt-[40px]" style={{ background: "#F2F8FA" }}>
        ...
        >
          <div
            className="decelera-mx-mark pointer-events-none absolute -right-[30px] -bottom-[34px] h-[125px] w-[125px]"
...
// Hero decoration for the "Decelera México 2026" card — the eight-petal
// rosette carved into the wooden Decelera México venue sign, redrawn as
// line art. Ties the app back to the program's real physical branding
// instead of a generic "Mexican" motif. Design source: Claude Design
// handoff "Diseño PWA Mesoamericana", frame 3A.
function DeceleraRosetteMark() {
  return (
    <svg
      aria-hidden="true"
